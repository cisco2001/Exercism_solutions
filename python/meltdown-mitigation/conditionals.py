...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    critical_factor = temperature * neutrons_produced_per_second
    if critical_factor < 0.9 * threshold:
        return "LOW"
    elif critical_factor >= -1.1 * threshold and critical_factor <= 1.1 * threshold:
        return "NORMAL"
    else:
        return "DANGER"
